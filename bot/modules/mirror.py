...
from bot import bot, Interval, INDEX_URL, VIEW_LINK, aria2, QB_SEED, dispatcher, DOWNLOAD_DIR, \
                ...
                botname, LOG_CHAT, LOG_CHAT_URL, OWNER_ID, SUDO_USERS \
...
class MirrorListener:
    ...
    def onUploadComplete(self, link: str, size, files, folders, typ, name: str):
        ...
        if self.isLeech:
            ...
            msg += f'\n<b>Leeched For: </b>{self.tag}\n\n'
            pmsg = 'I Have Sent Your Files In Your PM'
            fmsg = sendPrivateMsg(msg, self.bot, self.message)
            if LOG_CHAT:
                fmsg.copy(LOG_CHAT)
            pmsg += f'I Have Sent Files in <a href="{LOG_CHAT_URL}">Logs Channel</a>'    
            ...
            fmsg =sendPrivateMarkup(msg, self.bot, self.message, InlineKeyboardMarkup(buttons.build_menu(2)))
            if LOG_CHAT:
                fmsg.copy(chat_id=LOG_CHAT, reply_markup=InlineKeyboardMarkup(buttons.build_menu(2)))
