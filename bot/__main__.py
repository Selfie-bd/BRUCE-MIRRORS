...
def stats(update, context):
    ...
    stats = f'<b>╭──「☣️ 𝐒𝐓𝐀𝐓𝐒 ☣️」</b>\n' \
            ...
            f'<b>├⌬ Fʀᴇᴇ→</b> {mem_a}\n'\
            f'<b>╰─ Usᴇᴅ→</b> {mem_u}\n'
    update.effective_message.reply_photo("https://te.legra.ph/file/69d5c76e71e906a348c41.jpg", stats, parse_mode='HTMl')


def start(update, context):
    buttons = ButtonMaker()
    tag = update.message.from_user.mention_html(update.message.from_user.first_name)
    buttons.buildbutton("Repo", "https://github.com/Tysonmovierulz/BRUCE-MIRRORS")
    buttons.buildbutton("Report Group", "https://t.me/+0oXri_0r9PA0OTVl")
    reply_markup = InlineKeyboardMarkup(buttons.build_menu(2))
    if CustomFilters.authorized_user(update) or CustomFilters.authorized_chat(update):
        start_string = f''' 🙋 Hᴇʏ! {tag}.
I Cᴀɴ Mɪʀʀᴏʀ Aʟʟ Yᴏᴜʀ Lɪɴᴋs Tᴏ G-Dʀɪᴠᴇ.Sᴘᴇᴄɪᴀʟʟʏ Dᴇsɪɢɴᴇᴅ Fᴏʀ Bʀᴜᴄᴇ Mɪʀʀᴏʀ'S.
'''
